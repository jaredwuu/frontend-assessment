...
const Student = () => {
    ...
    const handleKeyDown = (e) => {
        if (e.key === "Enter" && newTag !== null) {
            ...
            // setData((data) => {
            //     data[student.id].myTags = [...data[student.id].myTags, newTag];
            //     return data;
            // });
            setTags((arr) => [...arr, newTag]);
            
            // setData((data) => {
            //    data[index].tags = [...data[index].tags, newTag];
            // })
            //setTags(tem);
            //newTag = null;
    ...
    const handleAddTag = (student) => {
        //console.log(tags)
        student.tags = [tags[parseInt(student.id) - 1]];
        //console.log(data)
        // console.log(tags);
                                        ...
                                        <div>
                                            ...
                                            <div className="px-8">
                                                ...
                                                <div className="flex py-2">
                                                    ...
                                                    />
                                                    <button
                                                        className="bg-white mx-2 px-2"
                                                        onClick={handleAddTag(x)}
                                                    >
                                                        add Tag
                                                    </button>
                                                </div>
